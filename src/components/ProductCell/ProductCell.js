const ProductCell = ({ product , onClick }) => {
    ...
    return (
      <div onClick={() => onClick(product)} className="flex rounded-md shadow-[0px_2px_2px_2px_rgba(0,0,0,0.25)] justify-between flex-col bg-[#6B3710] hover:bg-[#3E1900] p-2 flex-wrap text-[#FFC376] cursor-pointer">
